...
public class ModerationPage extends AbstractAdminPage {
    ...
    public ModerationPage() {
        ...
        add(moderationForm);
        DataView<BlogPostToModerate> dataView =
            new DataView<BlogPostToModerate>("pageable", requestHandler) {
                @Override
                protected void populateItem(final Item<BlogPostToModerate> item) {
