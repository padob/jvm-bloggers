...
class LastFiveIssuesQuerySpec extends NewsletterIssueRepositorySpecBase {
    ...
    private List<NewsletterIssueBaseData> populateTenNewsletterIssues(){
        ...
        for (issueNumber in 1L..10L ) {
            ...
            persistedIssues.add(newsletterIssueRepository.save(prepareNewsletterIssue(issueNumber, blogs, posts, "Example headingSection", "Example variaSection").publishedDate(publishedDate).build()))
        }
